...
class TransformerDecoderLayerOptimal(nn.Module):
    def __init__(self, d_model, nhead=8, dim_feedforward=2048, dropout=0.1, activation="relu",
        ...
        self.linear1 = Bit.Linear(d_model, dim_feedforward)
        self.linear2 = Bit.Linear(dim_feedforward, d_model)
...
class MLDecoder(nn.Module):
    def __init__(self, num_classes, num_of_groups=-1, decoder_embedding=768, initial_num_features=2048):
        ...
        self.embed_standart = Bit.Linear(initial_num_features, decoder_embedding)
