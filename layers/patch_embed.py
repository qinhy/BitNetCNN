...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.proj = Bit.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size, bias=bias)
...
#
#         self.flatten = flatten
#         self.proj = Bit.Conv2d(in_chans, embed_dim, kernel_size=self.patch_size, stride=self.patch_size, bias=bias)
#         self.norm = norm_layer(embed_dim) if norm_layer else nn.Identity()
#
#     def forward(self, x):
#         B, C, H, W = x.shape
